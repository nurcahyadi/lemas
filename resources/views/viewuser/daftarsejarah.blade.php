    ...
    <div class="row">
      ...
      <div class="col s3">
        ...
        <div class="card-image waves-effect waves-block waves-light">
          <img class="activator" src="{{asset('storage/'.$value->foto_sejarah)}}" style="width:400px; height:300px;">
        </div>
        <div class="card-content">
          <span class="card-title activator grey-text text-darken-4">{{$value->nama_sejarah}}<i class="material-icons right">more_vert</i></span>
          <p><a href="{{route('detailsejarahuser',['id'=>$value->id])}}">Read More</a></p>
        </div>
        <div class="card-reveal">
          <span class="card-title grey-text text-darken-4">{{$value->nama_sejarah}}<i class="material-icons right">close</i></span>
          <p>{{$value->deskripsi_sejarah}}</p>
        </div>
        </div>
      </div>
      @endforeach
