...
@section('header')
  ...
  <ul id="dropdown2" class="dropdown-content" style="padding:0px;">
    <li><a href="{{route('inputsanggar')}}">Input Sanggar Tari</a></li>
    <li><a href="{{route('datainputsanggar')}}">Daftar Sanggar Tari</a></li>
  </ul>
  ...
  <nav>
    <div class="nav-wrapper brown lighten-1">
      ...
      <ul id="nav-mobile" class="right hide-on-med-and-down">
        ...
        <li><a class="dropdown-web" data-target="dropdown2">Sanggar Tari<i class="material-icons right">arrow_drop_down</i></a></li>
