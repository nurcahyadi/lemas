...
<div class="row">
    <form class="card col s6 offset-s3" action="{{route('updatesejarah',['sejarah'=>$sejarah->id])}}" method="post" enctype="multipart/form-data">
      {{ csrf_field() }}

      <div class="row">
        <div class="input-field col s12">
          <input name="nama_sejarah" type="text" class="validate" value="{{$sejarah->nama_sejarah}}">
      ...
      <div class="row">
        <div class="input-field col s12">
          <textarea name="deskripsi_sejarah" class="materialize-textarea">{{$sejarah->deskripsi_sejarah}}</textarea>
