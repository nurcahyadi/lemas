...
<div class="row">
    <form class="card col s6 offset-s3" action="/createwisata" method="post" enctype="multipart/form-data">
      {{ csrf_field() }}

      <div class="row">
        <div class="input-field col s12">
          <input name="nama_wisata" type="text" class="validate">
      ...
      <div class="row">
        <div class="input-field col s12">
          <textarea name="deskripsi_wisata" class="materialize-textarea"></textarea>
      ...
      <div class="row">
        <div class="input-field col s12">
          <textarea name="alamat_wisata" class="materialize-textarea"></textarea>
